param([switch]$Test, [ValidateSet('all','transport','manual','evaluation','capabilities','cost-rerun','five-task','resource-integration','data-maintenance','backup-integration','flow-foundation','flow-integration','reuse-integration','local-integration','view-integration','training-datasets','training-root','materials-root','dataset-versions','asset-overview','media-recipes','payload')] [string]$TestScope = 'all')
