param([switch]$Test, [ValidateSet('all','transport','manual','evaluation','capabilities','cost-rerun','five-task','resource-integration','data-maintenance','backup-integration','flow-foundation','flow-integration','reuse-integration','local-integration','view-integration')] [string]$TestScope = 'all')
