...
export default function Tasks() {
  ...
  const [filter,setFilter]=useState('all'); const [search,setSearch]=useState(''); const [showAllRuns,setShowAllRuns]=useState(false);
