...
export default function Workbench() {
  ...
  return <div className={`workbench ${showTimeline ? 'has-video-timeline' : ''}`}>
    ...
    {mediaJob && <VideoJobCard jobId={mediaJob.id} temporarySource={mediaJob.temporarySource}
      ...
      onOpenTimeline={timelineId => { setMediaJob({ id: mediaJob.id, temporarySource: mediaJob.temporarySource, timelineId }); setMediaTaskId(mediaJob.id); void switchView('video'); }}
