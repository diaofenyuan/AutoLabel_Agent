...
const SETTINGS_TABS: ReadonlyArray<readonly [SettingsSection, string]> = [
  ['appearance','外观'],['ai','软件 AI 配置'],['workspace','工作空间'],['storage','存储位置'],['chats','对话记录'],['execution','执行与预算'],
  ['local','本地推理'],['media','视频工具'],['samples','示例'],['shortcuts','快捷键'],['updates','应用更新'],['diagnostics','诊断']
];
